...
\abstract{Dans le cadre de la 2\up{ème} année Master ALMA, le module \emph{Service}nous donne l'opportunité d'étudier les architectures distribuée telle que SOA (..), ainsi que des techniques de développement comme les méthdes agiles. Le but de ce document est de proposer le point de vue de notre bînome sur les méthodes agiles et l'architecture SOA. Dans la section \ref{sec:res} de ce document, nous proposons une critique d'un artiche de P. \textsc{Krutchen} consacrée à la coexistence entre les architectures logicielles et les méthodes agiles. Par la suite, la section \ref{sec:cri} contient le point de vue de notre bînome de l'article de P. \textsc{Krutchen}. Enfin dans l'ultime section \ref{sec:ret} nous reviendrons sur les notions étudiées proposant un nouveau point de vue.} 
