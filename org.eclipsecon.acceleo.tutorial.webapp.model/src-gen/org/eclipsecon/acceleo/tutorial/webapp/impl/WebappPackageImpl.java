...
import org.eclipsecon.acceleo.tutorial.webapp.Attribute;
import org.eclipsecon.acceleo.tutorial.webapp.Collection;
import org.eclipsecon.acceleo.tutorial.webapp.Model;
import org.eclipsecon.acceleo.tutorial.webapp.ModelView;
import org.eclipsecon.acceleo.tutorial.webapp.NamedElement;
import org.eclipsecon.acceleo.tutorial.webapp.Operation;
import org.eclipsecon.acceleo.tutorial.webapp.Parameter;
import org.eclipsecon.acceleo.tutorial.webapp.Reference;
import org.eclipsecon.acceleo.tutorial.webapp.Router;
import org.eclipsecon.acceleo.tutorial.webapp.RouterMapping;
import org.eclipsecon.acceleo.tutorial.webapp.StaticView;
import org.eclipsecon.acceleo.tutorial.webapp.WebappFactory;
...
public class WebappPackageImpl extends EPackageImpl implements WebappPackage {
	 ...
	 * @see org.eclipsecon.acceleo.tutorial.webapp.WebappPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getCollection_Model(), this.getModel(), null, "model", null, 0, 1, Collection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCollection_Application(), this.getApplication(), this.getApplication_Collections(), "application", null, 0, 1, Collection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(routerMappingEClass, RouterMapping.class, "RouterMapping", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRouterMapping_Path(), ecorePackage.getEString(), "path", null, 0, 1, RouterMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRouterMapping_View(), this.getAbstractView(), null, "view", null, 0, 1, RouterMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRouter_Application(), this.getApplication(), this.getApplication_Router(), "application", null, 0, 1, Router.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(abstractViewEClass, AbstractView.class, "AbstractView", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAbstractView_Description(), ecorePackage.getEString(), "description", null, 0, 1, AbstractView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAbstractView_Application(), this.getApplication(), this.getApplication_Views(), "application", null, 0, 1, AbstractView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(modelViewEClass, ModelView.class, "ModelView", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModelView_Collection(), this.getCollection(), null, "collection", null, 0, 1, ModelView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
