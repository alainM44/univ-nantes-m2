...
\title{ {\huge \textsc{Components and Architectures}} \\Master ALMA 2\up{eme} année \\\vspace{3cm} \emph{TP Composant : Implémentation HADL}\\{\small Encadrant : M.\textsc{Oussalah}}\vspace{3cm}}
