...
\overlays{6}{%
  \begin{slide}{Démarche et objectifs > Contexte \& objectifs}
    ...
    \begin{itemstep}
      ...
      \fromSlide{3}{\itemg Étudier leur compatibilité avec la démarche de génération de code}
      \fromSlide{4}{\itemg Choisir un framework adapté, et courament utilisé}
      \fromSlide{5}{\itemg Réaliser un générateur de code pour la technologie choisie}
    \end{itemstep}
    \bc{}
    \fromSlide{6}{\includegraphics[scale=.4]{img/logoPlay.eps} }
    \ec{}
  \end{slide}
}
...
\begin{slide}[Box]{Deploiement}
 \fromSlide{1}{ \bc{}
  ...
  \ec{}}
    \bi
    \fromSlide{2}{\item Démonstration}
    \ei
\end{slide}
}
