...
%\Logo(9,-0.70){\includegraphics[scale=0.5]{img/logouniv.eps}}
...
\overlays{3}{
  \begin{slide}[Box]{Présentation de \textsc{PSI}}
    \textbf{Création d'un outil de visualisation}
      ...
      \begin{Itemize}
        \fromSlide{2}{\item PSI est un société basée à Nantes. Fondée en 1996 par JP.\textsc{Bizet}.}
        \fromSlide{3}{\item Fort d’environ 120 000 collaborateurs et présent dans 40 pays}
      \end{Itemize}
  \end{slide}
}
\overlays{5}{
  \begin{slide}[Box]{Présentation de l'équipe}
    \textbf{L'équipe PSI pour ce projet}
    \begin{Itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\overlays{1}{
  \begin{slide}[Box]{Plan de charge}
    \slidetextsize
    toto
  \end{slide}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\overlays{1}{
  \begin{slide}[Box]{Plan de Facturation}
    \slidetextsize
    toto
  \end{slide}
}
