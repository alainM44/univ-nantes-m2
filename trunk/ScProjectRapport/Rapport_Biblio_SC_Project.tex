...
\rfoot{A.\textsc{Marguerite} \& M.\textsc{O}}
...
\hypersetup{
  ...
  pdfauthor={MARGUERITE Alain\\ OUAIRY Maxime},
...
\title{ {\huge \textsc{SC Project bibligraphy report}} \\Master ALMA 2\up{eme} année \\\vspace{3cm} \emph{Analyse of an article} \\ {\small Encadrant : M.\textsc{Oussalah}}\vspace{3cm}}
\titlepic{ \includegraphics[scale=0.2]{img/logouniv}}
\author{A.\textsc{Marguerite}\\ R.\textsc{Ouairy}\vspace{3cm}}
