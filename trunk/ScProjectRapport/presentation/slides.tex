\d\documentclass[HeilHazel,pdf,final,colorBG,slideColor]{prosper}
\usepackage{tikz}
\usepackage{epsfig}
...
%\slideCaption{A.\textsc{M} \& M.\textsc{O},Université de Nantes, FR \includegraphics[scale=0.05]{img/logouniv}}
...
\overlays{8}{%
  \begin{slide}[Box]{Methodology}
    ...
    \vspace{0,5cm}
    \fromSlide{5}{\item[$\blacksquare$] \textbf{Choosen papers:}}
    \end{enumerate}
