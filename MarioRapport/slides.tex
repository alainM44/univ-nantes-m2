\documentclass[blends,pdf,slideColor,colorBG,accumulate,total]{prosper}
...
\title{Advanced Software Composition}
\subtitle{An open component model an its support in Java}
%\caption{IR}
...
\overlays{1}{
  \begin{slide}[Box]{The \textsc{Fractal} component model}
      \begin{figure}[t]
        \begin{center}
          \includegraphics[width=0.8\textwidth]{img/component}
        \end{center}
      \end{figure}
  \end{slide}
}
